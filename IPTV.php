...
<div id="home" class="banner a-banner">
	...
	<div class="testimonials">
		<div class="container" align="center">
					<div class="testimonial-nfo wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					  <h3>IP TV Solution</h3>
						<br><h4>บริการด้านจัดทำระบบ IPTV ดู TV ผ่านระบบ IP ที่มีคามสามรถต่างจาก TV ทั่วไป</h4>
						<div class="wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<img src="images/iptv1.png" width="550px" height="350px" alt=""/>
					</div>
					<br />
					<div class="wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<img src="images/iptv2.png" width="550px" height="350px" alt=""/>
					</div>
	...
	<div class="footer">
		...
		<div class="container">
			...
			<div class="col-md-6 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
				<h3>Address</h3>
				<div class="address">
					<p>92/375 หมู่ที่ 5 ตำบลบางรักน้อย อำเภอเมืองนนทบุรี จังหวัด นนทบุรี 11000
						
					</p>
				</div>
				<div class="phone">
					<p>tel.02-926-1419 Phone 082-727-9850</p>
				</div>
			</div>
			<div class="clearfix"> </div>	
		</div>

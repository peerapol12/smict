...
<html>
<head>
<title>Truck a Transport Category Flat Bootstarp responsive Website Template| Single :: w3layouts</title>
			...
			<div class="header">
				...
				<div class="top-nav">
					...
					<ul class="nav1">
						...
						<li class="hvr-sweep-to-bottom"><a href="services.html"><i><img src="images/nav-but3.png" alt=""/> </i> </a></li>

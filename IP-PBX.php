...
<html>
<head>
<title>Corporate IP-PBX Solution</title>
	...
	<div class="testimonials">
		<div class="container" align="center">
					<div class="testimonial-nfo wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					  <h3>Corporate IP-PBX Solutions</h3><br>
					  		<h5 style="color: #000000;">บริการด้านการเชื่อมต่อระบบตู้โทรศัพท์ ระหว่างสาขาเพื่อให้โทรหากันฟรี ให้แก่องค์กร ด้วยเทคโนโลยี IP-PABX ของ Panasonic Solutions</h5>
					  
						<div class="wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
							<div class="fotorama" data-loop="true">
								<img src="images/IP-PBX1.png" />
								<img src="images/Ip-pbx2.png" />
								<img src="images/IP-PBX3.png" />
								<img src="images/IP-PBX4.png" />
							</div>
						</div>
					</div>
		</div>

				...
				<ul class="rslides" id="slider3">
					<li>
						<div class="banner-info">
								<h2><span> สมาร์ท ไอซีที </span> มีผู้เชี่ยวชาญระดับมืออาชีพ</h2>  
								<div class="line"> </div>
								<p>บริษัท สมาร์ท ไอซีที จำกัด 92/375 หมู่ที่ 5 ตำบลบางรักน้อย อำเภอเมืองนนทบุรี จังหวัด นนทบุรี 11000 โทร.02-926-1419 มือถือ.082-7279850 e-mail siriporn.s@smartict-th.com</p>
						</div>
					</li>
					<li>
						<div class="banner-info">
								<h2> มี <span> อุปกรณ์ เครื่องมือ  </span> ที่ทันสมัยและครบครัน</h2>
								<div class="line"> </div>
								<p>บริษัท สมาร์ท ไอซีที จำกัด 92/375 หมู่ที่ 5 ตำบลบางรักน้อย อำเภอเมืองนนทบุรี จังหวัด นนทบุรี 11000 โทร.02-926-1419 มือถือ.082-7279850 e-mail siriporn.s@smartict-th.com</p>
						</div>
					</li>
					<li>
						<div class="banner-info">
								<h2> การ  <span> บริการ  </span> ที่มีความแม่นยำและมีประสิทธิภาพสูง</h2>
								<div class="line"> </div>
								<p>บริษัท สมาร์ท ไอซีที จำกัด 92/375 หมู่ที่ 5 ตำบลบางรักน้อย อำเภอเมืองนนทบุรี จังหวัด นนทบุรี 11000โทร.02-926-1419 มือถือ.082-7279850 e-mail siriporn.s@smartict-th.com</p>
						</div>
					</li>
				</ul>
			</div>
